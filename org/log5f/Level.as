package org.log5f
{
	...
	public class Level extends Priority
	{
		...
		public static var OFF:Level		= new Level(Priority.OFF,	"OFF");
		public static var FATAL:Level	= new Level(Priority.FATAL,	"FATAL");
		public static var ERROR:Level	= new Level(Priority.ERROR,	"ERROR");
		public static var WARN:Level	= new Level(Priority.WARN,	"WARN");
		public static var INFO:Level	= new Level(Priority.INFO,	"INFO");
		public static var DEBUG:Level	= new Level(Priority.DEBUG,	"DEBUG");
		public static var ALL:Level		= new Level(Priority.ALL,	"ALL");
