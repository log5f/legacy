package org.log5f.layouts.converter
{
	...
	public class LineNumberConverterTest
	{
		...
		public function LineNumberConverterTest()
		{
			super();
		}
		...
		public function convert():void
		{
			...
			Assert.assertEquals("21", new LineNumberConverter().convert(event));
			...
			Assert.assertEquals("28", new LineNumberConverter().convert(event));
		}
	}
}